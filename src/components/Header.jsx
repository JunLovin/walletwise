        ...
        <header className="w-full h-16.5 flex justify-around items-center text-[var(--dark-blue-primary)] dark:text-[var(--light-gray-dark-mode)] transition-colors duration-300">
            ...
            <div className="header-right">
                <ul className="flex items-center">
                    ...
                    <li className="navBar"><Link to="/contacto">Contacto</Link></li>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" onClick={openModal} width="32" height="32" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" className="hidden cursor-pointer max-sm:block" strokeLinecap="round" strokeWidth="2" d="M5 7h14M5 12h14M5 17h14"/></svg>
                </ul>
            </div>
        </header>
        </>
